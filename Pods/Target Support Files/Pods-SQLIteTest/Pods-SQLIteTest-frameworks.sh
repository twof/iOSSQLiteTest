...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/VaporCore/Core.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VaporCoreAsync/Async.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VaporCoreBits/Bits.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VaporCoreCOperatingSystem/COperatingSystem.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VaporCoreDebugging/Debugging.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VaporService/Service.framework"
fi
